...
## Moving folders
mv $HOME/Void/config/.config/ $HOME/ && mv $HOME/Void/config/.zshrc /$HOME/.zshrc && mv $HOME/Void/config/.config /$HOME/ && sudo mv $HOME/Void/background/* $HOME/.config  &&  mv $HOME/Void/config/.zshnev /$HOME/ && mv $HOME/Void/config/.xinitrc $HOME/
